...
@Model.register("rnn_self_attention_crf")
class RnnSelfAttentionCrf(Model):
    """
    The ``RnnSelfAttentionCrf`` encodes a sequence of text with a ``Seq2SeqEncoder``,
    ...
    def __init__(self, vocab: Vocabulary,
        ...
        if feedforward is not None:
            ...
            output_dim = self.self_attention_encoder.get_output_dim()
        ...
        check_dimensions_match(encoder.get_output_dim(), self_attention_encoder.get_input_dim(),
                               "encoder output dim", "self attention encoder input dim")
        if feedforward is not None:
            check_dimensions_match(self_attention_encoder.get_output_dim(), feedforward.get_input_dim(),
    ...
    def forward(self,  # type: ignore
        ...
        encoded_text = self.self_attention_encoder(encoded_text, mask)
